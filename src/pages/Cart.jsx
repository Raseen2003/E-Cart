...
import { decrementQuantity, emptyCart, incrmentQuantity, removeCartItem } from '../redux/slices/cartSlice'
          ...
          <tbody>
            {
              userCart?.map((product,index)=>(
                ...
                <div className='flex'>
                 ...
                 <button onClick={()=>dispatch(incrmentQuantity(product?.id))} className='font-bold'>+</button>
                </div>
                </td>
